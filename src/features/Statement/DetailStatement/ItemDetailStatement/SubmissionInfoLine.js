...
class SubmissionInfoLine extends Component {
        ...
        {expanded && (
          ...
          >
            <View style={styles.itemDescription}>
              <Text style={styles.typeDescription}>Trích yếu nội dung</Text>
            ...
            <View style={styles.itemDescription}>
              <Text style={styles.typeDescription}>Cơ quan gửi</Text>
              <View style={styles.borderDescription}>
                <Text style={styles.deNghi}>
                  {itemStatementLine && itemStatementLine.adOrgId}
                </Text>
            ...
            <View style={styles.itemDescription}>
              <Text style={styles.typeDescription}>Người ký ban hành</Text>
              <View style={styles.borderDescription}>
                <Text style={styles.deNghi}>
                  {itemStatementLine && itemStatementLine.adOrgId}
                </Text>
            ...
            <View style={styles.itemDescription}>
              <Text style={styles.typeDescription}>Độ bảo mật</Text>
              <View style={styles.borderDescription}>
                <Text style={styles.deNghi}>
                  {itemStatementLine && itemStatementLine.adOrgId}
                </Text>
            ...
            <View style={styles.itemDescription}>
              <Text style={styles.typeDescription}>Độ khẩn cấp</Text>
              <View style={styles.borderDescription}>
                <Text style={styles.deNghi}>
                  {itemStatementLine && itemStatementLine.adOrgId}
                </Text>
...
export default SubmissionInfoLine;
